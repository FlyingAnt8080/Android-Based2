...
public class CrimeListFragment extends Fragment {
    ...
    private ImageButton mAddCrimeBtn;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAddCrimeBtn = view.findViewById(R.id.add_crime);
        mAddCrimeBtn.setOnClickListener((v)-> gotoCrimePagerActivityByCreate());
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.new_crime:
                gotoCrimePagerActivityByCreate();
                return true;
    ...
    /**
     * 创建新crime的形式跳转到CrimePagerActivity
     */
    public void gotoCrimePagerActivityByCreate(){
